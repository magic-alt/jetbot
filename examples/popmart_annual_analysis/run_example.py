"""泡泡玛特 2024 年报跨项目集成案例：PDF 分析 -> 财务事实导出 -> stock 基本面过滤。

Downloads the Pop Mart 2024 annual results announcement, runs the full
jetbot analysis pipeline, exports normalised financial facts (schema v1.0),
...
Usage:
    ...
    python examples/popmart_annual_analysis/run_example.py --url <other.pdf>
    python examples/popmart_annual_analysis/run_example.py --skip-stock
"""
...
# -- Defaults: Pop Mart 2024 Annual Results -------------------------------

DEFAULT_URL = (
    "https://www1.hkexnews.hk/listedco/listconews/"
    "sehk/2025/0326/2025032600485_c.pdf"
)
DEFAULT_COMPANY = "泡泡玛特"
DEFAULT_TICKER = "9992.HK"
...
def try_stock_integration(envelope: dict, ticker: str) -> None:
    ...
    export_dest = stock_export_dir / "popmart_2024_export.json"
    ...
    try:
        ...
        from src.strategies.fundamental_filter import FundamentalFilter  # noqa: E402
...
def main() -> int:
    ...
    print("=" * 70)
    print("  泡泡玛特 2024 年报 -- jetbot -> stock 跨项目集成案例")
    print("=" * 70)
